...
#### Image preprocessing
The images are preprocessed to produce the dataset and more detailed information can be found [here](https://github.com/akhilanirudhan/Alzheimers_Disease_Detection_Using_Deep_Learning/blob/main/preprocessing/description.md)
